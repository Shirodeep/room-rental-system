...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center p-2">
            ...
            <div class="col">
            <button href="./editprofile.php" class="btn btn-secondary" disabled>Edit profile</button>
            </div>
        </div>
        <div class="container-fluid d-flex flex-row flex-wrap">
            ...
            ?>
                ...
                ?>
                    ...
                    <a class="items p-1 m-1" href="removeprofileitems.php?id=<?php echo $rid ?>" style="color:black; text-decoration: none;border: 1px solid gray; border-radius: 15px;">
