 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light p-3">
     <a class="navbar-brand col-lg-6" href="../../index.php" style="font-weight: 20px;font-size:40px;font-family: 'Lucida Console', Courier, monospace;">   Room Rental System</a>
     ...
     <div class="collapse navbar-collapse col-lg-6" id="navbarSupportedContent">
         <ul class="navbar-nav mr-auto">
             ...
             <li class="nav-item">
                 <a class="nav-link navigation" href="#">About Us</a>
             </li>
